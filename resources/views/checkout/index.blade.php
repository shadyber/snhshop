                    ...
                    <div class="col-lg-6 offset-1">
                        <div class="billing-info-wrap">
                            ...
                            <form action="/shipping" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="billing-info mb-4">
                                            ...
                                            <input type="text" name="first_name" required value="{{$user->shippinginfo ? $user->shippinginfo->first_name : ''  }}">
                                            @error('first_name')
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="billing-info mb-4">
                                            ...
                                            <input type="text" name="last_name"  required value="{{$user->shippinginfo ? $user->shippinginfo->last_name : ''  }}">
                                            @error('last_name')
                                            <span class="invalid-feedback" role="alert">
                                                 <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="billing-info mb-4">
                                            ...
                                            <input class="billing-address" name="street_address" placeholder="House number and street name" type="text"  required value="{{$user->shippinginfo ? $user->shippinginfo->street_address : ''  }}">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="billing-info mb-4">
                                            ...
                                            <input type="text" name="city"  required value="{{$user->shippinginfo ? $user->shippinginfo->city : ''  }}">
                                            @error('city')
                                            <span class="invalid-feedback" role="alert">
                                                 <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="billing-info mb-4">
                                            ...
                                            <input type="text" name="state"   value="{{$user->shippinginfo ? $user->shippinginfo->state : ''  }}">
                                            @error('state')
                                            <span class="invalid-feedback" role="alert">
                                                 <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="billing-info mb-4">
                                            <label>Phone</label>
                                            <input type="text" name="phone"  required value="{{$user->shippinginfo ? $user->shippinginfo->phone : ''  }}">
                                            @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                 <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="billing-info mb-4">
                                            ...
                                            <input type="email" name="email"  value="{{$user->shippinginfo ? $user->shippinginfo->email : ''  }}">
                                            @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                 <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="checkout-account-toggle">
                                    <button type="submit" class="btn-hover checkout-btn btn-block" type="submit">Save Billing and Shipping Information</button>
                                </div>
