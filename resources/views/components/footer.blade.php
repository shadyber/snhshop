...
<!-- Footer Area Start -->
<div class="footer-area m-b-30px">
        ...
        <div class="modal-dialog p-0" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form class="navbar-form position-relative" role="search" action="/search" method="get">
...
<!-- Logout Modal-->
<div class="modal fade-in" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
...
@foreach(\App\Models\Item::lastN(16) as $item)
<!-- Modal -->
<div class="modal modal-2 fade" id="quickModal{{$item->id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                        ...
                        <div class="swiper-container zoom-thumbs mt-3 mb-3">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="{{$photo->thumb}}" alt="{{$photo->thumb}}">
                                </div>
                                    @endforeach
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                        <div class="product-details-content quickview-content">
                            ...
                            <p class="mt-30px mb-0">{{$item->detail}} </p>
