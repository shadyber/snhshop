            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                    ...
                    <div class="swiper-container zoom-top swiper-container-initialized swiper-container-horizontal">
                        <div class="swiper-wrapper" id="swiper-wrapper-84815180fc86d4d3" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                            <div class="swiper-slide zoom-image-hover swiper-slide-active" role="group" aria-label="1 / 4" style="width: 456px; position: relative; overflow: hidden;">
                                ...
                                <img role="presentation" alt="" src="http://localhost/fashions/assets/images/product-image/zoom-image/1.jpg" class="zoomImg" style="position: absolute; top: -100.128px; left: -27.8246px; opacity: 1; width: 560px; height: 694px; border: none; max-width: none; max-height: none;"></div>
                    ...
                    <div class="swiper-container zoom-thumbs mt-3 mb-3 swiper-container-initialized swiper-container-horizontal swiper-container-free-mode swiper-container-thumbs">
                        <div class="swiper-wrapper" id="swiper-wrapper-e34dbd7839f59443" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
